...
export function makeStartingCard() {
  ...
  card.frontSections.add(new CardHeading('Message', 'title', 'centre'))
  card.frontSections.add(new CardHeading('Cantrip 1', 'subtitle', 'centre'))

  const tagsSection = new CardTags()
  card.frontSections.add(tagsSection)
  ...
  card.frontSections.add(propertiesSection)
  ...
  card.frontSections.add(descriptionSection)
  ...
  card.frontSections.add(heighteningSection)
